...
namespace yii\helpSystem\admin\controllers;
...
use yii\helpSystem\models\Section;
use yii\helpSystem\models\Topic;
use yii\helpSystem\models\SectionText;
use yii\helpSystem\models\TopicText;

use yii\helpSystem\components\DMController;
use yii\helpSystem\admin\components\DataManagement;
use yii\helpSystem\admin\models\TopicForm;
	...
	public function behaviors(){
		return  [
				'access' => [
						...
						'ruleConfig' => [
								'class' => 'yii\helpSystem\admin\components\AccessRule'
						],
						'rules' => [
								[
										'allow' => true,
